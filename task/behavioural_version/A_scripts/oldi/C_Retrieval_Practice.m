...
input_prompt = {'Participant number'; 'Condition B';'Session (1=A, 2=B, 3=C, 4=D, 5=E, 6=F)'};
...
if exist([num2str(ID) '_' num2str(Session) '_randinfo.mat']) == 3
    ...
    check_answer = inputdlg(check_prompt, 'Not ok', 1, check_defaults);
...
time_trigger_mr=zeros(numTrials*2,7);
