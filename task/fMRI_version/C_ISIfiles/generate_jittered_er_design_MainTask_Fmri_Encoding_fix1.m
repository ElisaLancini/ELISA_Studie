function [meanrecipvif, vifs, design_struct] = generate_jittered_er_design_MainTask_Fmri_Encoding_fix1(varargin)
...
event1duration = 15.08;    % duration of all events but not fixation  (13 for encoding YA/OA, 10,5 for retrieval YA)
