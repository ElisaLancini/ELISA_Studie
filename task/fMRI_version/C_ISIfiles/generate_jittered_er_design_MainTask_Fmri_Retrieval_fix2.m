function [meanrecipvif, vifs, design_struct] = generate_jittered_er_design_MainTask_Fmri_Retrieval_fix2(varargin)
...
ISImean = 2;            % Mean duration of fixation cross
ISIstep = .65;          % Keep as it is
ISImax = 3;             % Maximum duration of fixation cross
